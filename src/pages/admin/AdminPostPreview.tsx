...
export default function AdminPostPreview() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <article>
        <h1 className="text-4xl md:text-6xl font-black uppercase leading-[.9]" style={{ fontFamily: 'var(--font-family-display)' }}>{post.title}</h1>
        ...
        <div className="ql-content prose-football" dangerouslySetInnerHTML={{ __html: post.content || '' }} />
